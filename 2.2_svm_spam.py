...
df = pd.read_csv('./large_files/datasets_483_982_spam.csv', encoding='ISO-8859-1')
...
# x[oc, word] = # times a word appears / # of documents containing word
...
# Outputs:
# (svm) D:\Repos\courses\svm>python 2.2_svm_spam.py
# train duration: 0:00:00.751098
# train score: 0.999196356817573 duration: 0:00:00.530616
# test score: 0.9820554649265906 duration: 0:00:00.258307